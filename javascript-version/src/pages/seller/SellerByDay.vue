...
import { useSellerByDayStore } from '@/plugins/stores/seller/seller-by-day'
import { storeToRefs } from 'pinia'
import { dcbs } from '@/plugins/stores/common/dcb'


const store = useSellerByDayStore();
...
const validateAndGetContents = () => {
    ...
    const thisMonth = getThisFullMonth();
...
const validateAndExportData = () => {
    ...
    const lastMonth = getThisFullMonth();
