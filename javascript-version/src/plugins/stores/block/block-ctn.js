...
export const useBlockCtnStore = defineStore('main', {
    state: () => ({
        dcb: '',
        contents: [],
        total: '',
    ...
    actions: {
        ...
        //     const API_URL = "http://192.168.10.134:8080/block/ctn";
        //     try {
        ...
        // async deleteContents(dcb, inputtedKeyword, ctns) {
        //     const API_URL = "http://192.168.10.134:8080/block/ctn";
        //     try {
        ...
        // async createContent(dcb, inputtedKeyword, ctn) {
        //     const API_URL = "http://192.168.10.134:8080/block/ctn";
        //     try {
        ...
        async getContents(dcb, inputtedKeyword, page = 1) {
            const API_URL = "http://localhost:8080/block/ctns";
            try {
                const response = await axios.get(API_URL, {
                    params: { dcb, ctn: inputtedKeyword, page, pageSize: this.pageSize }
                });
