...
export const usePurchaseAnalyzeStore = defineStore('main', {
    state: () => ({
        dcb: '',
        contents: [],
    }),
    ...
    actions: {
        ...
        async exportData(dcb, startDate, endDate) {
            ...
            try {
                ...
                const fileName = contentDisposition ? contentDisposition.split('filename=')[1] : `${dcb} ${startDate}~${endDate} 결제 통계 분석_${formattedTime}.xlsx`;
