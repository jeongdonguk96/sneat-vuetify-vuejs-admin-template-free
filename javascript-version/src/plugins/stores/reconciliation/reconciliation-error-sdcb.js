...
export const useReconciliationErrorStore = defineStore('main', {
    state: () => ({
        contents: [],
        total: '',
        pageSize: 10,
    ...
    actions: {
        ...
        async exportData(dcb, month, case_, ctn) {
            ...
            try {
                ...
                const fileName = contentDisposition ? contentDisposition.split('filename=')[1] : `${dcb} ${thisMonth} 대사 오류_${formattedTime}.xlsx`;
